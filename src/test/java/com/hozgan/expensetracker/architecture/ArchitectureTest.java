...
class ArchitectureTest {
  ...
  static final ArchRule domainShouldNotDependOnOtherLayers =
      noClasses()
          ...
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("..cli..", "..application..", "..infrastructure..");

  @ArchTest
  static final ArchRule applicationShouldNotDependOnCliOrInfrastructure =
      noClasses()
          .that()
          .resideInAPackage("..application..")
          .should()
          .dependOnClassesThat()
          .resideInAnyPackage("..cli..", "..infrastructure..");

  @ArchTest
  static final ArchRule cliShouldNotDependOnInfrastructure =
      noClasses()
          .that()
